...
describe('Test cases for blog API', () => {
	...
	describe('Test cases for getting all blog posts related to the user', () => {
		...
		/**
		 * @description test case for getting blogs related to user
		 */
		...
		/**
		 * @description test case for getting a 401 error response
		 */
		...
		/**
		 * @description test case for getting an empty response
		 */
